...
export function createPanels(root: HTMLElement, actions: PanelActions) {
  ...
  function showHelp() {
    ...
    c.innerHTML = `<div class="controls"><b>WASD / ARROWS</b><span>Move</span><b>F</b><span>Use your current Gift</span><b>E</b><span>Inspect, resonate, or plant</span><b>J</b><span>Open field journal</span><b>C</b><span>Meet your companion</span></div><p class="soft-copy help-note">The lights are suggestions, not a timer. Wander as long as you like.</p><div class="choice-row"><button class="button danger">Reset this world</button></div>`;
